...
class Web3Eth implements IWeb3Eth {
  ...
  // Modules
  late final Web3ABI _abi;
  late final Web3Accounts _accounts;
  late final Web3ENS _ens;
  late final Web3IBAN _iban;
  late final Web3Personal _personal;
  ...
  Web3Eth(BaseProvider provider) {
    ...
    // Modules
    this._abi = Web3ABI(_provider);
    this._accounts = Web3Accounts(_provider);
    this._ens = Web3ENS();
    this._iban = Web3IBAN();
    this._personal = Web3Personal();
  }
  ...
  IWeb3Abi get abi => _abi;

  IWeb3Accounts get accounts => _accounts;

  Web3ENS get ens => _ens;

  Web3IBAN get iban => _iban;

  Web3Personal get personal => _personal;
