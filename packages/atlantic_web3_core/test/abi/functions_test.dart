...
import 'package:atlantic_web3_core/atlantic_web3_core.dart' hide equals;
...
void main() {
  ...
  test('parses contract abi', () {
    ...
    final ContractAbi? abi = null;
    //ContractAbi.fromString('''
// [
//   {
//     "name": "f",
//     "type": "function",
...
//      ''');
    ...
    final s = function.inputs[0];
    final t = function.inputs[1];
    final a = function.inputs[2];
